...
const FloorLeaders: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h2 className="text-2xl font-bold text-surface-900">Qavat Sardorlari</h2>
          <p className="text-sm text-surface-600">Qavat sardorlarini boshqarish</p>
        </div>
        <motion.div
        ...
        {!isLoading && leaders.length > 0 ? (
              ...
              <Card className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-surface-900">{leader.user_info.username}</h3>
                      <p className="text-sm text-surface-600">{leader.floor_info.name}</p>
                      <p className="text-xs text-surface-500">{leader.user_info.email}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-surface-900">Qavat: {leader.floor}</p>
                    <p className="text-xs text-surface-500 capitalize">{leader.floor_info.gender}</p>
                  </div>
                </div>
              </Card>
            </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <Card className="text-center py-12">
              ...
              <p className="text-surface-500">Hali qavat sardorlari yo'q</p>
              <p className="text-sm text-surface-400 mt-1">Birinchi sardorni qo'shing</p>
            </Card>
          </motion.div>
        ) : null}
      </motion.div>
          ...
          >
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-surface-900">Yangi Qavat Sardori</h2>
                <button
                  onClick={() => setShowForm(false)}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-[5px] focus:outline-none focus:ring-2 focus:ring-brand-500 ${
                      errors.username ? 'border-danger-500' : 'border-surface-300'
                    }`}
                    placeholder="Foydalanuvchi nomini kiriting"
                  />
                  {errors.username && (
                    <p className="text-danger-500 text-sm mt-1">{errors.username}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3 py-2 pr-10 border rounded-[5px] focus:outline-none focus:ring-2 focus:ring-brand-500 ${
                        errors.password ? 'border-danger-500' : 'border-surface-300'
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-[5px] focus:outline-none focus:ring-2 focus:ring-brand-500 ${
                      errors.floorName ? 'border-danger-500' : 'border-surface-300'
                    }`}
                    placeholder="Qavat nomini kiriting"
                  />
                  {errors.floorName && (
                    <p className="text-danger-500 text-sm mt-1">{errors.floorName}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-[5px] focus:outline-none focus:ring-2 focus:ring-brand-500 ${
                      errors.floorNumber ? 'border-danger-500' : 'border-surface-300'
                    }`}
                    placeholder="Qavat raqamini kiriting"
                    min="1"
                  />
                  {errors.floorNumber && (
                    <p className="text-danger-500 text-sm mt-1">{errors.floorNumber}</p>
                  )}
                </div>
